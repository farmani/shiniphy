...
{
	import flare.physics.Particle2;
	import flare.physics.Simulation2;
	 ...
	 * <code>Simulation2</code> used to drive this layout can be set explicitly,
	 ...
	 * layout is mapped to a <code>Particle2</code> instance and each edge
	 ...
	 * @see flare.physics
	 */
	public class ForceDirectedLayout2 extends Layout
	{
		private var _sim:Simulation2;
		...
		public function get simulation():Simulation2 { return _sim; }
		...
		/**
		 * Creates a new ForceDirectedLayout2.
		 ...
		 */
		public function ForceDirectedLayout2(enforceBounds:Boolean=false, 
			iterations:int=1, sim:Simulation2=null)
		{
			_enforceBounds = enforceBounds;
			_iter = iterations;
			_sim = (sim==null ? new Simulation2(0, 0, 0.1, -10) : sim);
		}
		
		/** @inheritDoc */
		protected override function layout():void
		{
			//Remove dead DataSprites
			var bfound:Boolean = true;
			while(bfound)
			{
				bfound = false;
		...
		{
			var p:Particle2 = d.props.particle;
			if (!p.fixed) {
				var o:Object = _t.$(d);
				o.x = p.x;
				o.y = p.y;
		...
		/**
		 * Initializes the Simulation2 for this ForceDirectedLayout2
		 */
		protected function init():void
		{
			var data:Data = visualization.data, o:Object;
			var p:Particle2, s:Spring, n:MovieSprite, e:EdgeSprite;
			...
			for each (n in data.nodes) {
				...
				p.radial_distance = n.radial_distance;
				p.angle = n.angle2;
				p.tag = _gen;
			}
	...
	} // end of class ForceDirectedLayout2
}